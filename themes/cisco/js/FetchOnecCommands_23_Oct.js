$(document).ready(function(){
    ...
    return function(){
            ...
            var sub_topology = $('#sub_topology').val();
...
//            var ntw_device =  ["NetworkDevice_0", "NetworkDevice_1", "NetworkDevice_2", "NetworkDevice_3", "NetworkDevice_4", "NetworkDevice_5", "NetworkDevice_6", "NetworkDevice_7", "NetworkDevice_8", "NetworkDevice_9", "NetworkDevice_10", "NetworkDevice_11", "NetworkDevice_12"];
            ...
            interval = setInterval(function(){
                ...
                if(processing==0 && cmdStatus == 0)
                {
                    ...
                    $.ajax({
                   url: BASE_URL+"/AjaxCustom/FetchOnecCommandsFiles",
                   type: 'POST',
                   dataType: 'json',
                   async:true,
                   data:{ topology:topology, sub_topology:sub_topology, region:region, city:city, folderPath:folderPath, currDevice:currDevice , action:''},
                   beforeSend:function(){
                            processing = 1;
                            if(boxesScroll==5)
                            {
