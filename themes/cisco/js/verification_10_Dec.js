...
$('.autoVer').live("click",(function(container){
    return function(){
        ...
        var cnt = 0;
        var isConnected = 0;
        var cmdsArray = new Array("show ip bgp vpnv6 uni all summary","show isis neighbors","sh mpls ldp neighbor","show ip bgp summary", "show ip bgp vpnv4 all summary", "show ip bgp vpnv6 unicast all summary", "sh run vrf RJIL-OAM-ENB", "sh run vrf RJIL-BEARER-ENB", "sh run vrf RJIL-IME", "sh run vrf RJIL-SIGNALING-ENB");
        
//        var cmdsArray = new Array("sh run vrf RJIL-OAM-ENB");
        ...
        interval = setInterval(function(){
            ...
            {   
                ...
                $.ajax({
                    url: BASE_URL+"/AutomationIntegration/automationVer",
                    type: 'post',
                    dataType: 'json',
                    data: {sap_id : sap_id,self_loopback0 : self_loopback0, isConnected:isConnected, action:cmdsArray[cnt] },
                    beforeSend:function(){
