jQuery(document).ready(function($) {
    ...
    addOrRemoveRecordsFromPartner = function($left, $right, option, $moveFrom) {
        ...
        $.ajax({
            ...
            async: false,
            dataType: 'JSON',
            data: {selected_ids: selected_ids, sol_par_id: $('#SolutionPartner_circles').val(), addRemoveflag: addRemoveflag, map_for:'installation'},
    ...
    loadEmployeeDataForPartner = function() {
        ...
        document.location = BASE_URL + '/solutionpartner/MapSolEnggToSolparForInstln' + appendUrl;
    };
