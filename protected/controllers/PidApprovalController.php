...
//                $this->performAjaxValidation($model);
    ...
    public function actionUpdate($id) {
        ...
        $projectCStatus = SubProject::model()->find($model->sub_project_id)->status;
...
//         }
    ...
    public function actionfetchSubProjectIdAndHours() {
        ...
        $utilized = Yii::app()->db->createCommand("SELECT BIG_SEC_TO_TIME( SUM( BIG_TIME_TO_SEC( `hours` ) ) ) AS utilized_hrs  FROM tbl_day_comment where spid={$_POST['project_id']}")->queryRow();
        $projectformat['utilized'] = $utilized;
