...
<table class="table table-bordered responsive" id="projectreports">
    ...
    <tbody>
        <?php if(!empty($records)){ ?>
            ...
            <tr>
                <td><?php echo $record['program_id']; ?></td>
                <td><?php echo $record['program_name']; ?></td>
                <td><?php echo $record['project_id']; ?></td>
                <td><?php echo $record['project_name']; ?></td>
                <td><?php echo $record['allocated']; ?></td>
                ...
                <td><?php echo $record['utilized_hours']; ?></td>
