...
<!--        <div class="navbar navbar-inverse navbar-fixed-top">
 ...
 <div class="row">
		<?php echo $form->labelEx($model,'Select date for task submit'); ?>
		<?php // echo $form->textField($model,'inception_date'); ?>
           <?php echo $form->textField($model, 'day', array('id' => 'inception_date', 'class' => 'datepicker', 'placeholder' => 'Select Date', 'style' => 'width:200px;')); ?>
                            ...
                            <table  class="table table-hover small-text" id="tb">
                                ...
                                <tbody id="hoursBody">
                                    <tr>
                                        ...
                                        <td class="Program">
                                            <?php echo CHTML::dropDownList('ProjectName[]','pid', CHtml::listData(CommonUtility::getProject_byEmp_id($emp_id), 'pid', 'project_name'), array('style' => 'width:150px;', 'prompt' => 'Please select Program', 'class' => 'form-control')); ?>
