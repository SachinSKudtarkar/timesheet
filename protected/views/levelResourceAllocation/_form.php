...
<!--	<p class="note">Fields with <span class="required">*</span> are required.</p>-->
    ...
    <form class="form no-mr clearfix" action="<?php echo Yii::app()->baseUrl; ?>/levelresourceallocation/allocate" method="post" id="allocaterform">
        ...
        <div class="row">
            ...
            <?php echo CHtml::dropDownList('LevelName', $model->level_id, CHtml::listData(LevelMaster::model()->findAll(array('order' => 'level_id')), 'level_id', 'level_name'), array('prompt' => 'Please select Level'));
            ?>
        </div>
