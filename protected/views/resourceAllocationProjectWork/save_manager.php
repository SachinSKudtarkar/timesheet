...
<body>
    <form class="form no-mr clearfix" action="<?php echo Yii::app()->baseUrl; ?>/resourceallocationprojectwork/SetManager" method="post" > 
        ...
        <div class="mgr">
            ...
            echo CHtml::dropDownList("manager", 'id', $emp_list, array('multiple' => 'multiple', 'style' => 'height:200px;margin-top:20px;'));
            ?>       
        </div>
