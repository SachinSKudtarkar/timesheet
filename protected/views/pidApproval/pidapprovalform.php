...
<div class="modal-body clearfix">
    ...
    'id'=>'forgot-password-form',
     'action' => Yii::app()->createUrl('//'.$module_name.'/approvalstatus'),
		//'action' => Yii::app()->createUrl('//pidMapping/admin'),	//<- your form action here
...
<input type='hidden' name='approval_id' id='sendapproval' />
