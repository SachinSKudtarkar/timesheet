...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('year_month')); ?>:</b>
	<?php echo CHtml::encode($data->year_month); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('sub_task_id')); ?>:</b>
	<?php echo CHtml::encode($data->sub_task_id); ?>
	<br />
