...
<?php $this->renderPartial('_form', array('model'=>$model,'levels'=>$levels,'hours_label'=>$hours_label,'levels_log'=>$levels_log, 'estimatedArr'=>$estimatedArr,'excelHours'=>$excelHours)); ?>