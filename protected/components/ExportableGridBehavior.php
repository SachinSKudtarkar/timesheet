...
class ExportableGridBehavior extends CBehavior {
     ...
     * @param integer $limit resultset limit for CActiveDataProvider
     */
    public function exportCSV($data, $attributes = array(), $endApplication = true, $endLineCount = 0, $limit = 150) {
        if ($this->isExportRequest()) {
            ...
            if ($data instanceof CActiveDataProvider) {
                ...
                $this->csvRowModels($fileHandle, new CDataProviderIterator($data, $limit), $attributes);
                ...
                foreach ($data as $vals) {
                    fputcsv($fileHandle, $vals, $this->csvDelimiter, $this->csvEnclosure);
                }
